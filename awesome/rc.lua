...
antiforensicmenu = {
  ...
  { "zsteg", "urxvt -e sh -c 'zsteg -h ; bash'" },
  { "zsteg-mask", "urxvt -e sh -c 'zsteg-mask ; bash'" },
  { "zsteg-reflow", "urxvt -e sh -c 'zsteg-reflow ; bash'" },
}
...
automationmenu = {
  ...
  { "semver", "urxvt -e sh -c 'semver ; bash'" },
  { "uuid", "urxvt -e sh -c 'uuid ; bash'" },
  { "resolve", "urxvt -e sh -c 'resolve ; bash'" },
  { "semver", "urxvt -e sh -c 'semver ; bash'" },
  { "uuid", "urxvt -e sh -c 'uuid ; bash'" },
  ...
  { "dorkscout", "urxvt -e sh -c 'dorkscout -h ; bash'" },
  ...
  { "emp3r0r", "urxvt -e sh -c 'emp3r0r -h ; bash'" },
  { "empire-client", "urxvt -e sh -c 'empire-client ; bash'" },
  { "empire-server", "urxvt -e sh -c 'empire-server ; bash'" },
  ...
  { "oscap-remediate-offline", "urxvt -e sh -c 'oscap-remediate-offline ; bash'" },
  ...
  { "shellz", "urxvt -e sh -c 'shellz -h ; bash'" },
...
debuggermenu = {
  ...
  { "ghidra", "urxvt -e sh -c 'ghidra ; bash'" },
  { "ghidra-analyzeHeadless", "urxvt -e sh -c 'ghidra-analyzeHeadless ; bash'" },
  { "heaptrace", "urxvt -e sh -c 'heaptrace -h ; bash'" },
  ...
  { "plasma-disasm", "urxvt -e sh -c 'plasma-disasm -h ; bash'" },
  { "sleighc", "urxvt -e sh -c 'sleighc ; bash'" },
...
defensivemenu = {
  ...
  { "dbpwaudit", "urxvt -e sh -c 'dbpwaudit -h ; bash'" },
  { "dependency-check", "urxvt -e sh -c 'dependency-check ; bash'" },
  ...
  { "tor-browser", "urxvt -e sh -c 'tor-browser ; bash'" },
...
proxymenu = {
  ...
  { "proxybroker", "urxvt -e sh -c 'proxybroker -h ; bash'" },
...
radiomenu = {
  ...
  { "hackrf_sweep", "urxvt -e sh -c 'hackrf_sweep ; bash'" },
  { "hackrf_transfer", "urxvt -e sh -c 'hackrf_transfer ; bash'" },
  { "osmo-aka-verify", "urxvt -e sh -c 'osmo-aka-verify ; bash'" },
  ...
  { "mf_nonce_brute", "urxvt -e sh -c 'mf_nonce_brute ; bash'" },
  { "mf_trace_brute", "urxvt -e sh -c 'mf_trace_brute ; bash'" },
  { "mfd_aes_brute", "urxvt -e sh -c 'mfd_aes_brute ; bash'" },
  { "mfd_multi_brute", "urxvt -e sh -c 'mfd_multi_brute ; bash'" },
  { "pm3", "urxvt -e sh -c 'pm3 -h ; bash'" },
  { "proxmark3", "urxvt -e sh -c 'proxmark3 -h ; bash'" },
  { "mf_nonce_brute", "urxvt -e sh -c 'mf_nonce_brute ; bash'" },
  { "mf_trace_brute", "urxvt -e sh -c 'mf_trace_brute ; bash'" },
  { "mfd_aes_brute", "urxvt -e sh -c 'mfd_aes_brute ; bash'" },
  { "mfd_multi_brute", "urxvt -e sh -c 'mfd_multi_brute ; bash'" },
  ...
  { "simtrace2-cardem-pcsc", "urxvt -e sh -c 'simtrace2-cardem-pcsc ; bash'" },
  { "simtrace2-list", "urxvt -e sh -c 'simtrace2-list -h ; bash'" },
  { "simtrace2-sniff", "urxvt -e sh -c 'simtrace2-sniff -h ; bash'" },
  { "simtrace2-tool", "urxvt -e sh -c 'simtrace2-tool ; bash'" },
...
reconmenu = {
  ...
  { "adidnsdump", "urxvt -e sh -c 'adidnsdump -h ; bash'" },
  ...
  { "gh-dork", "urxvt -e sh -c 'gh-dork -h ; bash'" },
  { "git-hound", "urxvt -e sh -c 'git-hound -h ; bash'" },
  { "git-wild-hunt", "urxvt -e sh -c 'git-wild-hunt -h ; bash'" },
  ...
  { "graphinder", "urxvt -e sh -c 'graphinder -h ; bash'" },
  ...
  { "setup", "urxvt -e sh -c 'setup ; bash'" },
  { "spring", "urxvt -e sh -c 'spring ; bash'" },
  { "holehe", "urxvt -e sh -c 'holehe -h ; bash'" },
  { "homepwn", "urxvt -e sh -c 'homepwn -h ; bash'" },
  ...
  { "msmailprobe", "urxvt -e sh -c 'msmailprobe -h ; bash'" },
  { "mylg", "urxvt -e sh -c 'mylg help ; bash'" },
  ...
  { "osintgram", "urxvt -e sh -c 'osintgram -h ; bash'" },
  ...
  { "pown", "urxvt -e sh -c 'pown ; bash'" },
  { "pret", "urxvt -e sh -c 'pret -h ; bash'" },
  { "protosint", "urxvt -e sh -c 'protosint -h ; bash'" },
  { "proxmark", "urxvt -e sh -c 'proxmark ; bash'" },
  { "proxmark-fpga-compress", "urxvt -e sh -c 'proxmark-fpga-compress ; bash'" },
  { "mf_nonce_brute", "urxvt -e sh -c 'mf_nonce_brute ; bash'" },
  { "mf_trace_brute", "urxvt -e sh -c 'mf_trace_brute ; bash'" },
  ...
  { "pwndora", "urxvt -e sh -c 'pwndora -h ; bash'" },
  ...
  { "rdwarecon", "urxvt -e sh -c 'rdwarecon -h ; bash'" },
  ...
  { "scrying", "urxvt -e sh -c 'scrying -h ; bash'" },
  { "scylla", "urxvt -e sh -c 'scylla -h ; bash'" },
  { "of-access", "urxvt -e sh -c 'of-access -h ; bash'" },
  { "of-check", "urxvt -e sh -c 'of-check -h ; bash'" },
  { "of-enum", "urxvt -e sh -c 'of-enum -h ; bash'" },
  { "of-flood", "urxvt -e sh -c 'of-flood -h ; bash'" },
  ...
  { "smbsr", "urxvt -e sh -c 'smbsr -h ; bash'" },
  { "smod", "urxvt -e sh -c 'smod ; bash'" },
  ...
  { "poriluk", "urxvt -e sh -c 'poriluk -h ; bash'" },
  { "seitan", "urxvt -e sh -c 'seitan -h ; bash'" },
  { "teamsuserenum", "urxvt -e sh -c 'teamsuserenum -h ; bash'" },
  { "address6", "urxvt -e sh -c 'address6 ; bash'" },
  { "alive6", "urxvt -e sh -c 'alive6 ; bash'" },
  { "connect6", "urxvt -e sh -c 'connect6 ; bash'" },
  { "covert_send6", "urxvt -e sh -c 'covert_send6 ; bash'" },
  ...
  { "token-hunter", "urxvt -e sh -c 'token-hunter -h ; bash'" },
  ...
  { "uncover", "urxvt -e sh -c 'uncover -h ; bash'" },
...
scannermenu = {
  ...
  { "apachetomcatscanner", "urxvt -e sh -c 'apachetomcatscanner -h ; bash'" },
  ...
  { "fs-nyarl", "urxvt -e sh -c 'fs-nyarl -h ; bash'" },
  { "chaosreader0.94", "urxvt -e sh -c 'chaosreader0.94 ; bash'" },
  { "fscan", "urxvt -e sh -c 'fscan -h ; bash'" },
  ...
  { "graphinder", "urxvt -e sh -c 'graphinder -h ; bash'" },
  { "graphql-cop", "urxvt -e sh -c 'graphql-cop -h ; bash'" },
  ...
  { "httpx-pd", "urxvt -e sh -c 'httpx-pd ; bash'" },
  { "hawk", "urxvt -e sh -c 'hawk --help ; bash'" },
  { "hwk-eagle", "urxvt -e sh -c 'hwk-eagle --help ; bash'" },
  { "iax-scan-hosts", "urxvt -e sh -c 'iax-scan-hosts -h ; bash'" },
  { "iax-scan-users", "urxvt -e sh -c 'iax-scan-users -h ; bash'" },
  ...
  { "katana-framework-ktfrun", "urxvt -e sh -c 'katana-framework-ktfrun ; bash'" },
  { "katana-framework-ktfupdate", "urxvt -e sh -c 'katana-framework-ktfupdate ; bash'" },
  { "katana", "urxvt -e sh -c 'katana -h ; bash'" },
  { "kiterunner", "urxvt -e sh -c 'kiterunner -h ; bash'" },
  { "knock", "urxvt -e sh -c 'knock ; bash'" },
  ...
  { "linpeas_fat", "urxvt -e sh -c 'linpeas_fat ; bash'" },
  { "pentbox", "urxvt -e sh -c 'pentbox ; bash'" },
  { "pentestly", "urxvt -e sh -c 'pentestly -h ; bash'" },
  ...
  { "sdnpwn", "urxvt -e sh -c 'sdnpwn ; bash'" },
  { "seat", "urxvt -e sh -c 'seat -h ; bash'" },
  { "second-order", "urxvt -e sh -c 'second-order -h ; bash'" },
  ...
  { "scap-driver-loader", "urxvt -e sh -c 'scap-driver-loader ; bash'" },
  { "sysdig", "urxvt -e sh -c 'sysdig -h ; bash'" },
  { "csysdig", "urxvt -e sh -c 'csysdig ; bash'" },
  { "scap-driver-loader", "urxvt -e sh -c 'scap-driver-loader ; bash'" },
  { "sysdig", "urxvt -e sh -c 'sysdig -h ; bash'" },
  { "tachyon-scanner", "urxvt -e sh -c 'tachyon-scanner ; bash'" },
  { "easywin", "urxvt -e sh -c 'easywin -h ; bash'" },
  { "letmein", "urxvt -e sh -c 'letmein -h ; bash'" },
  { "netdork", "urxvt -e sh -c 'netdork -h ; bash'" },
  { "poriluk", "urxvt -e sh -c 'poriluk -h ; bash'" },
  ...
  { "tlspretense", "urxvt -e sh -c 'tlspretense ; bash'" },
  { "tlssled", "urxvt -e sh -c 'tlssled -h ; bash'" },
  { "tlsx", "urxvt -e sh -c 'tlsx -h ; bash'" },
  { "topera", "urxvt -e sh -c 'topera -h ; bash'" },
  { "torcrawl", "urxvt -e sh -c 'torcrawl -h ; bash'" },
  { "traxss", "urxvt -e sh -c 'traxss -h ; bash'" },
  { "trivy", "urxvt -e sh -c 'trivy -h ; bash'" },
  { "typo3scan", "urxvt -e sh -c 'typo3scan -h ; bash'" },
  { "udork", "urxvt -e sh -c 'udork -h ; bash'" },
  { "udp-hunter", "urxvt -e sh -c 'udp-hunter -h ; bash'" },
  { "udsim", "urxvt -e sh -c 'udsim -h ; bash'" },
  { "umap", "urxvt -e sh -c 'umap -h ; bash'" },
...
socialmenu = {
  ...
  { "gitrecon", "urxvt -e sh -c 'gitrecon -h ; bash'" },
  { "gloom", "urxvt -e sh -c 'gloom ; bash'" },
  { "gocabrito", "urxvt -e sh -c 'gocabrito -h ; bash'" },
  { "gomapenum", "urxvt -e sh -c 'gomapenum -h ; bash'" },
  { "h8mail", "urxvt -e sh -c 'h8mail -h ; bash'" },
...
tunnelmenu = {
  ...
  { "neo-regeorg", "urxvt -e sh -c 'neo-regeorg ; bash'" },
  { "ngrok", "urxvt -e sh -c 'ngrok ; bash'" },
  { "oniongrok", "urxvt -e sh -c 'oniongrok -h ; bash'" },
  { "packet-o-matic", "urxvt -e sh -c 'packet-o-matic -h ; bash'" },
  { "pr0cks", "urxvt -e sh -c 'pr0cks -h ; bash'" },
  { "proxytunnel", "urxvt -e sh -c 'proxytunnel -h ; bash'" },
  { "ptunnel", "urxvt -e sh -c 'ptunnel -h ; bash'" },
...
voipmenu = {
  ...
  { "awesome-footer.tmpl", "urxvt -e sh -c 'awesome-footer.tmpl ; bash'" },
  { "awesome-header.tmpl", "urxvt -e sh -c 'awesome-header.tmpl ; bash'" },
  { "awesome-menu", "urxvt -e sh -c 'awesome-menu ; bash'" },
  { "fluxbox-footer.tmpl", "urxvt -e sh -c 'fluxbox-footer.tmpl ; bash'" },
  { "fluxbox-header.tmpl", "urxvt -e sh -c 'fluxbox-header.tmpl ; bash'" },
  { "fluxbox-menu", "urxvt -e sh -c 'fluxbox-menu ; bash'" },
  { "help-flags.txt", "urxvt -e sh -c 'help-flags.txt ; bash'" },
  { "menu-maker.sh", "urxvt -e sh -c 'menu-maker.sh ; bash'" },
  { "openbox-footer.tmpl", "urxvt -e sh -c 'openbox-footer.tmpl ; bash'" },
  { "openbox-header.tmpl", "urxvt -e sh -c 'openbox-header.tmpl ; bash'" },
  { "openbox-menu", "urxvt -e sh -c 'openbox-menu ; bash'" },
  { "storm-ring", "urxvt -e sh -c 'storm-ring -h ; bash'" },
